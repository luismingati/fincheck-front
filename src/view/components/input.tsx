...
export const Input = forwardRef<HTMLInputElement, InputProps>(({placeholder, name, id, error, className, ...props}, ref) => {
  ...
  return (
    <div className="relative">
      ...
      <label
        htmlFor={name}
        className="absolute text-xs left-3 top-1.5 pointer-events-none text-gray-700 peer-placeholder-shown:text-base peer-placeholder-shown:top-2 transition-all">
